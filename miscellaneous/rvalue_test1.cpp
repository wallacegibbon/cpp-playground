...
int main(int argc, const char **argv) {
    ...
    // int &m = i++; // error: cannot bind non-const lvalue reference of type ‘int&’ to an rvalue of type ‘int’
    ...
    // int &&x = j; // error: cannot bind rvalue reference of type ‘int&&’ to lvalue of type ‘int’
    int &&x = std::move(j);
